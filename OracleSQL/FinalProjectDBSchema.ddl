...
ALTER TABLE board ADD CONSTRAINT board_member_FK FOREIGN KEY ( writer )
REFERENCES member ( mid ) ;

ALTER TABLE hobby ADD CONSTRAINT hobby_member_FK FOREIGN KEY ( mid ) REFERENCES
member ( mid ) ;

ALTER TABLE order_item ADD CONSTRAINT order_item_orders_FK FOREIGN KEY (
orders_ono ) REFERENCES orders ( ono ) ;

ALTER TABLE order_item ADD CONSTRAINT order_item_product_FK FOREIGN KEY (
product_pno ) REFERENCES product ( pno ) ;

ALTER TABLE orders ADD CONSTRAINT orders_member_FK FOREIGN KEY ( member_mid )
REFERENCES member ( mid ) ;
