...
public class HomeActivity extends AppCompatActivity {
    ...
    public void handleBtnWebBrowser(View v) {
        Intent intent = new Intent(Intent.ACTION_VIEW, Uri.parse("http://192.168.3.138:8080/SensingCarRemoteWebControlProject"));
        startActivity(intent);
    }
    ...
    public void handleBtnDialActivity(View v) {
        ...
        if(permission == PackageManager.PERMISSION_GRANTED) {
            Intent intent = new Intent(Intent.ACTION_CALL, Uri.parse("tel:010-7516-7478"));
            startActivity(intent);
        } else {
