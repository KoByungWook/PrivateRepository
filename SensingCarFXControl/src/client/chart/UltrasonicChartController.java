...
public class UltrasonicChartController implements Initializable {
            ...
            public void run() {
                coapObserveRelation = coapClient.observe(new CoapHandler() {
                    ...
                    public void onLoad(CoapResponse response) {
                        ...
                        sensorValue.setTemperature(distance);
                        ...
                        for (int i = 0; i < distanceList.size(); i++) {
                            ...
                            circle.setCenterX(550 - (50 * (distanceList.size() - i - 1)));
                            circle.setCenterY(350 - ((300 / 400.0) * distanceList.get(i)));
