...
public class MainControlPanelController implements Initializable {
    ...
    private void setTemperature() {
        ...
        coapClient.setURI("coap://192.168.43.166/thermistorsensor");
    ...
    private void setGas() {
        CoapClient coapClient = new CoapClient();
        coapClient.setURI("coap://192.168.43.166/gassensor");
    ...
    private void setTracking() {
        CoapClient coapClient = new CoapClient();
        coapClient.setURI("coap://192.168.43.166/trackingsensor");
...
//        try {
//            cameraView.setCurrentURL(new URL("http://192.168.43.166:50001/?action=stream"));
...
//        vboxCamera.getChildren().add(cameraView);
    ...
    private void handleVboxCameraReleased() {
        ...
        stackPane.getChildren().add(anchorPane);
        btnCameraReturn.setOnAction(e -> handleBtnReturn());
    }
