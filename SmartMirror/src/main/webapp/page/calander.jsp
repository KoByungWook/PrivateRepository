...
<html>
    	...
    	<script type="text/javascript">
    		function checkScript(message) {
    			...
    			if(script == "날씨") {
    				...
    				$("#calander").css("width","80%");
    				$("#calander").css("height","1600px");
    			} else if(script == "달력축소") {
    				$("#calander").css("width","40%");
    				$("#calander").css("height","800px");
    			} else if(script == "달력리셋") {
    				$("#calander").css("width","60%");
    				$("#calander").css("height","1200px");
    			} else if(script == "카메라") {
	...
	<body class="" id="body" style="background-color:black;text-align:center;">
		...
		<div data-role="page" style="margin-top:500px;">
		  <div role="main" class="ui-content">
		  	<iframe id="calander" src="https://calendar.google.com/calendar/embed?showTitle=0&amp;showNav=0&amp;showPrint=0&amp;showTabs=0&amp;showCalendars=0&amp;showTz=0&amp;height=500&amp;wkst=1&amp;hl=en&amp;bgcolor=%23ffcccc&amp;src=jyk60222%40gmail.com&amp;color=%23B1440E&amp;ctz=Asia%2FSeoul" style="border-width:0;width:60%;height:1200px;" frameborder="0" scrolling="no"></iframe>
		  </div>
		</div>
