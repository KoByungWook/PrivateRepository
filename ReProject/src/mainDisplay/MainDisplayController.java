...
public class MainDisplayController implements Initializable {
    ...
    private void handleBtnMainInterphone(ActionEvent e) {
        ...
        try {
            ...
            MediaPlayer frontMediaPlayer = new MediaPlayer(frontMedia);		//스레드 1개 생성
            mediaView.setMediaPlayer(frontMediaPlayer);		//스레드 1개 생성
            frontMediaPlayer.play();	//스레드 1개 생성
