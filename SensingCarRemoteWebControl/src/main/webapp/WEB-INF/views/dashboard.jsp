...
<html>
	...
	<body>
		<div class="container-fluid" style="background-color:#eeeeee;width:80%;">
			<div class="row">
				<div class="col-md-5">
					<div class="row" style="background-color:#ffffff;border:1px solid #f8f8f8;border-radius:5px;margin:10px;">
						<div style="background-color:#f8f8f8;;border-radius:5px 5px 0px 0px;font-size:16px;">DC Motor Control</div>
						<div style="height:260px;"></div>
					</div>	
					<div class="row">
						<div class="col-md-6">
							<div class="row" style="background-color:#ffffff;border:1px solid #f8f8f8;border-radius:5px;margin:10px;">
								<div style="background-color:#f8f8f8;;border-radius:5px 5px 0px 0px;font-size:16px;">RGBLed Control</div>
								<div style="height:260px;"></div>
							</div>	
						</div>
						<div class="col-md-6">
							<div class="row" style="background-color:#ffffff;border:1px solid #f8f8f8;border-radius:5px;margin:10px;">
								<div style="background-color:#f8f8f8;;border-radius:5px 5px 0px 0px;font-size:16px;">LCD Display Control</div>
								<div style="height:260px;"></div>
							</div>
						</div>
					</div>				
				...
				<div class="col-md-7">
					<div class="row" style="background-color:#ffffff;border:1px solid #f8f8f8;border-radius:5px;margin:10px;">
						...
						<div class="row">
							<div onmouseover="showThermistorSensorChart()" class="col-md-2" style="height:70px;">
								<span style="font-size:15px;"><i class="fa fa-thermometer-three-quarters"  aria-hidden="true"></i> Temperature</span>
             					<div id="divTemperature" style="text-align:center;font-size:25px;">0</div>
							</div>
							<div onmouseover="showUltrasonicSensorChart()" class="col-md-2" style="height:70px;">
								<span style="font-size:15px;"><i class="fa fa-exchange" aria-hidden="true"></i> Distance</span>
             					<div id="divDistance" style="text-align:center;font-size:25px;">0</div>
							</div>
							<div onmouseover="showPhotoresistorSensorChart()" class="col-md-2" style="height:70px;">
								<span style="font-size:15px;"><i class="fa fa-lightbulb-o" aria-hidden="true"></i> Brightness</span>
             					<div id="divPhoto" style="text-align:center;font-size:25px;">0</div>
							</div>
							<div onmouseover="showGasSensorChart()" class="col-md-2" style="height:70px;">
								<span style="font-size:15px;"><i class="fa fa-cloud"  aria-hidden="true"></i> Gas Con.</span>
             					<div id="divGas" style="text-align:center;font-size:25px;">0</div>
							</div>
							<div onmouseover="showTrackingSensorChart()" class="col-md-2" style="height:70px;">
								<span style="font-size:15px;"><i class="fa fa-adjust" aria-hidden="true"></i> Tracking</span>
					...
					<div class="row" style="background-color:#ffffff;border:1px solid #f8f8f8;border-radius:5px;margin:10px;">
						...
						<div style="height:320px;">
							<div id="chartContainer" style="height:320px;text-align:center;">
								<br/><br/><br/><br/><br/>자세히 보고 싶은 데이터 위에<br/>마우스를 올려주세요.
							</div>
						</div>
					</div>	
				</div>
