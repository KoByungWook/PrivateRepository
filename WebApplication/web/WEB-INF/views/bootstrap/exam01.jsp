...
<html>
	 <head>
			...
			<link href="/WebApplication/resources/bootstrap-3.3.7/bootstrap/css/bootstrap.min.css" rel="stylesheet" type="text/css"/>
			<script src="/Webapplication/resources/jquery/jquery-3.2.1.min.js" type="text/javascript"></script>
			<script src="/Webapplication/resources/bootstrap-3.3.7/bootstrap/js/bootstrap.min.js" type="text/javascript"></script>
	 </head>
	 <body>
			<h3> 버튼 </h3>
